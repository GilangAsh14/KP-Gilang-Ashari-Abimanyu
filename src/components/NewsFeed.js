            ...
            <Card style={{ padding: 15, borderWidth: 1, marginBottom: 30, marginLeft: 50, marginRight: 50, boxShadow: '1px 2px 5px gray', }}>
                <div style={{ marginLeft: 30, marginRight: 30, display: 'flex', flexDirection: 'row', }} >
                    ...
                    <div>
                        ...
                        <p style={{ marginLeft: 10, width: '100%', fontSize: 14, padding: 10, borderRadius: 10, color: '#2e2e2e' }}>Dimasa pandemi sekarang ini,indonesia menjadi salah satu negara yang mewajibkan masyarakat untuk Booster jika ingin menaiki KRL.Syarat Naik KRL Terbaru Wajib Booster? Cek Aturan Lengkapnya di Sini!</p>
                ...
                <div style={{ marginLeft: 30, marginRight: 30, display: 'flex', flexDirection: 'row', }} >
                    ...
                    <div>
                        ...
                        <div style={{ marginLeft: 20, display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                            ...
                            <a href="Detail1" style={{ textDecoration: 'none' }}>Baca Selengkapnya >></a>
                        </div>
                    </div>
                </div>
            </Card >
            ...
            <Card style={{ padding: 15, borderWidth: 1, marginBottom: 30, marginLeft: 50, marginRight: 50, boxShadow: '1px 2px 5px gray', }}>
                <div style={{ marginLeft: 30, marginRight: 30, display: 'flex', flexDirection: 'row', }} >
                    ...
                    <div>
                        ...
                        <div style={{ marginLeft: 20, display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                            <p>17 Januari, 2022</p>
                            <a href="Detail2" style={{ textDecoration: 'none' }}>Baca Selengkapnya >></a>
                        </div>
                    </div>
                </div>
            </Card >
                ...
                <div style={{ marginLeft: 30, marginRight: 30, display: 'flex', flexDirection: 'row', }} >
                    ...
                    <div>
                        ...
                        <div style={{ marginLeft: 20, display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                            ...
                            <a href="Detail3" style={{ textDecoration: 'none' }}>Baca Selengkapnya >></a>
                        </div>
                    </div>
                </div>
            </Card >
