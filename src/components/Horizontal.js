            ...
            <div className="row" style={{ marginLeft: '5%', marginRight: '5%', justifyContent: 'space-between' }}>
                ...
                <Card border="white" style={{ width: 300, marginLeft: -5, marginRight: -5 }}>
                    ...
                    <Card.Body style={{ alignItems: 'center' }}>
                        ...
                        <a href='Detail1' style={{ textDecoration: 'none' }}>  <Card.Text style={{ width: 280, fontSize: 14, fontWeight: '600' }}>BI Lampung sebut inflasi Juli capai 0,73 persen</Card.Text> </a>
                ...
                <Card border="white" style={{ width: 300, marginLeft: -5, marginRight: -5 }}>
                    ...
                    <Card.Body style={{ alignItems: 'center' }}>
                        ...
                        <a href='Detail2' style={{ textDecoration: 'none' }}> <Card.Text style={{ width: 280, fontSize: 14, fontWeight: '600' }}>Tak Ada Fasilitas, Atlet Panjat Tebing Lampura Latihan di Bandar Lampung</Card.Text> </a>
                ...
                <Card border="white" style={{ width: 300, marginLeft: -5, marginRight: -5 }}>
                    ...
                    <Card.Body style={{ alignItems: 'center' }}>
                        ...
                        <a href='Detail3' style={{ textDecoration: 'none' }}>  <Card.Text style={{ width: 280, fontSize: 14, fontWeight: '600' }}>Pemerintah diminta respons cepat maraknya situs judi online</Card.Text> </a>
